@ echo off
    ...
    rem 
    rem set argfile=config_d_hydro.xml
set argfile=config_dflow2d3d.xml
    ...
    rem
set ARCH=win32
set D3D_HOME=D:\Delft3D 4.01.00\win32\flow2d3d\bin
set exedir=C:\Program Files\Deltares\Delft3D 4.04.02\x64\dflow2d3d\bin
...
set MPIPATH="C:\Program Files (x86)\MPICH2\bin"
...
%MPIPATH%\mpiexec -n 8 -localonly %exedir%\d_hydro.exe %argfile%
